    ...
    public static ExecutorService getNewVirtualExecutor(String prefix) {
        ...
        Runtime.getRuntime().addShutdownHook(getVirtualFactory().newThread(() -> {
            if (!executorService.isTerminated()) {
                ...
                Runnable logTask = () -> LoggingUtil.logIfAvailable(Level.INFO, "ExecutorService=%s - Shutting down for %ss...".formatted(prefix, (System.currentTimeMillis() - startTime) / 1000));
