...
public class HzController {
    ...
    @GetMapping("/objects")
    public List<DistributedObjectDto> getDistributedObjectDtos(@RequestParam(name = "queryType", required = false, defaultValue = "LOCAL") QueryType queryType) {
        return hazelcastStatsCollector.getDistributedObjectDtos(queryType);
    }
