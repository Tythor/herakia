...
public class HzMapService {
    ...
    public void validateMapExists(String mapName) {
    ...
    public MapStats getMapStats(Member member, String mapName) {
        ...
        Optional<Boolean> showConfig = RequestContextUtil.get("showConfig");
        Optional<Boolean> showKeys = RequestContextUtil.get("showKeys");
        Optional<Boolean> showValues = RequestContextUtil.get("showValues");
        Optional<Boolean> showMap = RequestContextUtil.get("showMap");
