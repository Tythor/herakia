...
public class AdvisoryLockManager {
    ...
    @Autowired
    public AdvisoryLockManager(HikariDataSource hikariDataSource) {
        this.hikariDataSource = createNewHikariDataSource(hikariDataSource);
    }
    ...
    public AdvisoryLock obtain(Object key) {
        return lockMap.computeIfAbsent(key, k -> new AdvisoryLock(k, connectionMap, hikariDataSource));
    }
