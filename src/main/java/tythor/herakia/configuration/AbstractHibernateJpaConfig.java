...
public abstract class AbstractHibernateJpaConfig {
    ...
    private HikariConfig hikariConfig() {
        ...
        bindProperties("spring.datasource", hikariConfig);
        bindProperties("spring.datasource.hikari", hikariConfig);

        if (hikariConfig.getJdbcUrl() == null) {
            DataSourceProperties dataSourceProperties = new DataSourceProperties();
            bindProperties("spring.datasource", dataSourceProperties);
