...
public abstract class AbstractHibernateJpaConfig {
    ...
    protected Set<String> additionalEntityClasses() {
        return Set.of();
    }
    ...
    private PersistenceManagedTypes createPersistenceManagedTypes(String basePackage, String regexFilter) {
        ...
        classes.addAll(additionalEntityClasses());

        return PersistenceManagedTypes.of(classes.stream().distinct().toArray(String[]::new));
    }
